...
/* static char *fonts[]          = { "JetBrainsMono Nerd Font:size=10", "JetBrainsMono Nerd Font:pixelsize=10:antialias=true:autohint=true"  }; */
...
static Key keys[] = {
  ...
  /* { MODKEY,			XK_c,		spawn,		SHCMD("clipmenu") }, */
	...
	{ 0, XF86XK_Calculator,		spawn,		SHCMD(TERMINAL " -e bc -l ~/.bcrc") },
