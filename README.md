...
- [Clickable statusbar](https://dwm.suckless.org/patches/statuscmd/) with my build of [dwmblocks](https://github.com/Syuq/dwmblocks).
...
```
git clone https://github.com/Syuq/Dwm
cd Dwm
sudo make install
```
